...
4.  We'll use a CDC dataset on COVID-19 mortality from here:\
    ...
    - Make a line plot of the covid death rate in `crude_rate` vs the date for the years 2020-2021.\
    ...
    - Make a line plot of the covid death rate in `crude_rate` vs the date for 2020-2021.\
    ...
    - +3 points: make a version of the `facet_grid` plot above where there is a separate colored line for each `jurisdiction_residence`.\
