...
```{r}
p = us_hosps_deaths |> 
  ggplot(aes(x = week_end_date, y = total_admissions_all_covid_confirmed)) +
...
hist <- add_histogram(base,
  x = ~total_admissions_all_covid_confirmed, 
...
subplot(ggplotly(gg), hist, nrows = 2) |>
